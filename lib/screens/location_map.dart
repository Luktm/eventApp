...
class _LocationMapState extends State<LocationMap> {
  ...
  static final LatLng _center = LatLng(_initCenter.latitude + 0.011500, _initCenter.longitude);

  final double locationInfoSizebWidth = 20.0;
  final double locationInfoSizedBoxMargin = 20.0;
  final double tableRowSizedBoxHeight = 20;
