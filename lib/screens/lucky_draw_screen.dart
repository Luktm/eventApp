...
class _LuckyDrawScreenState extends State<LuckyDrawScreen> {
  ...
  void didChangeDependencies() {
    if (_isInit) {
      ...
      //    _boxOneController.text = auth.lucky.substring(0, 1);
      //     print(_boxOneController.text);
      // });
                ...
                children: <Widget>[
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      initialValue: auth.lucky.substring(0, 1),
                      enabled: false,
                  ...
                  Container(
                    ...
                    // height: 50,
                    child: TextFormField(
                      initialValue: auth.lucky.substring(1,2),
                  ...
                  Container(
                    ...
                    // height: 50,
                    child: TextFormField(
                      initialValue: auth.lucky.substring(3, 4),
                  ...
                  Container(
                    ...
                    // height: 50,
                    child: TextFormField(
                      initialValue: auth.lucky.substring(2,3),
                      enabled: false,
